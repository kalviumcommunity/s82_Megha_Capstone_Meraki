        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <button 
                    ...
                    className="flex items-center justify-center p-3 border border-gray-100 rounded-2xl hover:bg-white hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all group disabled:opacity-50 disabled:cursor-not-allowed"
                >
