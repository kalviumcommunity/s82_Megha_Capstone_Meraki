    ...
    return (
        <div className="hidden md:flex items-center gap-1 transition-all">
            ...
            >
                ...
                {activeMenu === 'explore' && (
                    <div className="absolute left-0 pt-2 z-[100] animate-in fade-in slide-in-from-top-4 duration-300">
                        <div className="w-[480px] bg-white border border-gray-100 rounded-[2.5rem] shadow-2xl p-6">
            ...
            >
                ...
                {activeMenu === 'learning' && (
                    <div className="absolute left-0 pt-2 z-[100] animate-in fade-in slide-in-from-top-4 duration-300">
                        <div className="w-80 bg-white border border-gray-100 rounded-[2rem] shadow-2xl p-4">
